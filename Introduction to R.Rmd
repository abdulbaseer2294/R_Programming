...
x<- c("a", "b", "d", "u", "l")      #abdul first part of my name
#(2)
x    # all my name alphabets in variable x 
y<- c("b", "a", "s", "e", "e", "r")  #baseer second part of my name
y
z<- c(x,y)    #concatenating x and y
z

#(3)
s<- 100:120   #s contains sequence from 100 to 120
...
eemp_status<- factor(c("employed", "unemployed", "self_employed"))
#(2)
eemp_status
levels(emp_status)
nlevels(emp_status)
...
bank_costumers<- data.frame()




# Create the data frame.
bank_costumers <- data.frame(costomer_id = c (1:5), 
 # costumer_name = c("Alicia","Nancy","Fernando","Louis","Diane"),
  hasAccount= c("NO", "YES", "YES", "YES", "NO"),
  totalBalance = c(0,10000,0,2000,0), 
  
  
  stringsAsFactors = FALSE
)
# Print the data frame.			
print(bank_costumers) 
nrow(bank_costumers)
ncol(bank_costumers)
names(bank_costumers)
